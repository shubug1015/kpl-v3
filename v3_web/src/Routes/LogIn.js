...
const LogInBox = styled.div`
  border-radius: 7px;
  border: ${(props) => props.theme.softMainBorder};
...
const SnsLogIn = styled.div`
  border-top: ${(props) => props.theme.softMainBorder};
  padding-top: 10px;
`;
  ...
  return (
    <Container>
      <LogInBox>
        ...
        <SnsLogIn>
          <Box>{/* <KakaoLogIn history={history} /> */}</Box>
          <Box>{/* <NaverLogIn history={history} /> */}</Box>
          <Box>
            <SLink to='/signup'>
